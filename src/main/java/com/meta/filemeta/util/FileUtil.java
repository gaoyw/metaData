...
import com.meta.filemeta.model.ImgInfoBean;
...
public class FileUtil {
	...
	public static void main(String[] args) {
		ImgInfoBean imgInfoBean = new FileUtil().parseImgInfo("C:\\Users\\gaoy\\Pictures\\水印.png");
		// System.out.println(JSON.toJSONString(imgInfoBean, true));
	}
}
